...
**Instructions :**
	...
	2)  Make sure that pandas,numpy,matplotlib,seaborn,scipy and sklearn modules are installed in your python environment,
	      As these modules are used in project.

	3)  Open "Assignment2.ipynb" file & from Main menu, do following; 
	
		Kernel ==> Restart & Run All

	4)  "Assignment2.ipynb" will be executed with all operations including Cleaning, Exploration, Model building & Prediction 
